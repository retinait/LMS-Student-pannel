...
import { Row, Col, Typography, Input, Card, Button, Image, Space, Popover, Modal, Progress } from 'antd';
							...
							<Space>
								{question.extra.map(item =>
									item.type.includes('image') ? (
										...
										<a
											href={`${(item.key?.startsWith('user') ? bucket_url_old : bucket_url)}${item.key}`}
											target='_blank'
											rel='noreferrer'
										>
											<img
