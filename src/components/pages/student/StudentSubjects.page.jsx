...
import './StudentSubjects.page.style.css';
...
const StudentSubjects = props => {
	...
	console.log('courseCompletionData', courseCompletionData);
	...
	return (
		<Layout>
			...
			<Layout>
				{courseData && <Content className='custom-container student-subjects-page section-padding sec-mh'>
